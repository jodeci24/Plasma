...
Win32keyConvert plKeyMap::fKeyConversionEnglish[] =
{
    ...
    { KEY_SLASH,            "ForewardSlash" },
    { KEY_TILDE,            "Tilde"         },
    { KEY_LBRACKET,         "LeftBracket"   },
    { KEY_BACKSLASH,        "Backslash"     },
    { KEY_RBRACKET,         "RightBracket"  },
    { KEY_QUOTE,            "Quote"         },
    { KEY_UNMAPPED,         "Unused"        },
};
...
Win32keyConvert  plKeyMap::fKeyConversionFrench[] =
{
    ...
    { KEY_UP,    "FlècheHaut"}, 
    { KEY_DOWN,  "FlècheBas"}, 
    { KEY_LEFT,  "FlècheGauche"},
    { KEY_RIGHT, "FlècheDroite"},
    { KEY_BACKSPACE,  "Retour"},
    { KEY_ENTER, "Entrée"}, 
    { KEY_PAUSE, "Pause"},
    { KEY_CAPSLOCK, "CapsLock"},
    { KEY_PAGEUP, "PagePréc"},
    { KEY_PAGEDOWN,  "PageSuiv"},
    { KEY_END,   "Fin"},
    { KEY_HOME,  "Origine"},
...
Win32keyConvert  plKeyMap::fKeyConversionGerman[] =
{
    ...
    { KEY_TAB,   "Tab"},
    { KEY_UP,    "PfeilHoch"}, 
    { KEY_DOWN,  "PfeilRunter"}, 
    { KEY_LEFT,  "PfeilLinks"},
    { KEY_RIGHT, "PfeilRechts"},
    { VK_BACK,  "Backspace"},
    { VK_RETURN, "Enter"}, 
    { KEY_PAUSE, "Pause"},
...
Win32keyConvert  plKeyMap::fKeyConversionItalian[] =
{
    ...
    { VK_INSERT,    "Ins"},
    { VK_DELETE,    "Canc"},
    { KEY_NUMPAD0,   "TastNum0"}, 
    { KEY_NUMPAD1,   "TastNum1"}, 
    { KEY_NUMPAD2,   "TastNum2"}, 
    { KEY_NUMPAD3,   "TastNum3"},
    { KEY_NUMPAD4,   "TastNum4"},
    { KEY_NUMPAD5,   "TastNum5"},
    { KEY_NUMPAD6,   "TastNum6"}, 
    { KEY_NUMPAD7,   "TastNum7"},
    { KEY_NUMPAD8,   "TastNum8"},
    { KEY_NUMPAD9,   "TastNum9"},
    { VK_MULTIPLY,  "TastNum*"},
    { VK_ADD,       "TastNum+"},
    { VK_SUBTRACT,  "TastNum-"},
    { VK_DECIMAL,   "TastNum."},
